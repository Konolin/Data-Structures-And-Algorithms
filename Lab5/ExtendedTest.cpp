...
void testBonus(Relation r) {
    cout << "Test bonus" << endl;
    ...
    SortedSetIterator si = s.iterator();
    si.first();
    assert(si.getCurrent() == 1);
    ...
    si.next();
    assert(si.getCurrent() == 3);

    si.next();
    assert(si.getCurrent() == 4);
